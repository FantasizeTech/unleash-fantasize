...
settings updates using the existing transactional services, permissions and audit
log. CREATE_PROJECT is required to create, UPDATE_PROJECT to edit. Project count
